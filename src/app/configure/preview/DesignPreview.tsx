...
const DesignPreview = ({ configuration }: DesignPreviewProps) => {
  ...
  const { mutate: createPaymenteSession } = useMutation({
  ...
  const handleCheckout = () => {
    if (user) {
      ...
      createPaymenteSession({ configId: id });
    } else {
      // need to log in
        ...
        <div className="sm:col-span-12 md:col-span-9 text-base">
          ...
          <div className="mt-8">
            <div className="bg-gray-50 p-6 sm:rounded-lg sm:p-8">
              <div className="flow-root text-sm">
                ...
                <div className="flex items-center justify-between py-2">
                  <p className="font-semibold text-gray-900">Preço total</p>
            ...
            <div className="mt-8 flex justify-end pb-12">
              ...
              >
                Continuar <ArrowRight className="h-4 w-4 ml-1.5 inline" />
              </Button>
            </div>
          </div>
        </div>
